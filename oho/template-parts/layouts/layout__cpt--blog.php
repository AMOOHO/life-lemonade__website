        ...
        <div class="box box-xl-4">
          <?php if ($img) : ?>
            <div class="slanted-image-wrap relative">
              <div class="slanted-image slanted-image--overlap covered-image-wrap ratio--16_10 bg--dark rounded-sm">
                <picture>
...
<section class="sec-wrap">
  ...
  <div class="sec-wrap__inner">
    ...
    <?php endif; ?>
    <a href="<?= get_post_type_archive_link('blog'); ?>" class="block text-center mt-xl-5">
